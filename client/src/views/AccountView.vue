<template>
    <div>
      ...
      <div class="meWrapper">
        <div>
            Name:  <InputText v-model="nameModel" disabled="disabled"/>
        </div>
        ...
        <Dialog v-model:visible="passwordDialogVisible" modal header="Update password">
            <div class="dialogContent">
                <div class="row">
                    <div>Old</div>  <InputText type="password" v-model="oldPasswordModel"  autocomplete="current-password" class="input" v-on:keyup.enter="onClickSubmitNameChange"/>
                </div>
                <div class="row">
                    New <InputText type="password" v-model="newPasswordModel" class="input"  autocomplete="new-password" v-on:keyup.enter="onClickSubmitPasswordChange"/>
                </div>
